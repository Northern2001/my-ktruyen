...
import { MKTTrackList } from "./MKTTrackList";
...
const replacementGalleryItems = withGalleryDefaults([
  {
    numberTrack: 1,
    durationSeconds: 183.336,
    title: "SOS",
    subtitle: "ZIK, 邹沛沛",
    imageUrl: "/images/mkt/IMG_3259.jpg",
    pMobileBackground: "right",
    audioUrl: "/music/SOS.mp3",
    type: "pulled",
  },
  {
    numberTrack: 2,
    durationSeconds: 296.228571,
    title: "Biển, Đảo Và Em",
    subtitle: "Mã Dã (Crabbit)",
    imageUrl: "/images/mkt/IMG_3265.jpg",
    pMobileBackground: "left",
    bMobileBackground: 0.7,
    audioUrl: "/music/biển đảo và em.mp3",
    type: "pulled",
  },
  {
    numberTrack: 3,
    durationSeconds: 212.16,
    title: "不完整的心",
    subtitle: "邹沛沛",
    imageUrl: "/images/mkt/IMG_7587.jpg",
    bMobileBackground: 0.425,
    audioUrl: "/music/不完整的心.mp3",
    type: "pulled",
  },
  {
    numberTrack: 4,
    durationSeconds: 180.11425,
    title: "底牌",
    subtitle: "Max李玄, 邹沛沛",
    imageUrl: "/images/mkt/IMG_7633.jpg",
    bMobileBackground: 0.55,
    audioUrl: "/music/底牌.mp3",
    type: "pulled",
  },
  {
    numberTrack: 5,
    durationSeconds: 163.296,
    title: "惦念你",
    subtitle: "邹沛沛",
    imageUrl: "/images/mkt/IMG_7649.jpg",
    pMobileBackground: "right",
    audioUrl: "/music/惦念你.mp3",
    type: "pulled",
  },
  {
    numberTrack: 6,
    durationSeconds: 211.344,
    title: "是否太滥情",
    subtitle: "邢益豪, 邹沛沛",
    imageUrl: "/images/mkt/cover-001.jpg",
    audioUrl: "/music/是否太滥情.mp3",
    type: "pulled",
  },
  {
    numberTrack: 7,
    durationSeconds: 183.432,
    title: "月光下曖昧",
    subtitle: "邹沛沛",
    imageUrl: "/images/mkt/cover-008.jpg",
    audioUrl: "/music/月光下曖昧.mp3",
    type: "pulled",
  },
  {
    numberTrack: 8,
    durationSeconds: 177.984,
    title: "梦臆",
    subtitle: "邹沛沛",
    imageUrl: "/images/mkt/cover-019.jpg",
    audioUrl: "/music/梦臆.mp3",
    type: "pulled",
  },
  {
    numberTrack: 9,
    durationSeconds: 193.8,
    title: "沉溺（你让我的心不再结冰）",
    subtitle: "邹沛沛, Pank",
    imageUrl: "/images/mkt/cover-021.jpg",
    audioUrl: "/music/沉溺（你让我的心不再结冰）.mp3",
    type: "pulled",
  },
  {
    numberTrack: 10,
    durationSeconds: 183.816,
    title: "沦陷（Sink Into）",
    subtitle: "Juggshots",
    imageUrl: "/images/mkt/cover-026.jpg",
    bMobileBackground: 0.35,
    audioUrl: "/music/沦陷（Sink Into）.mp3",
    type: "pulled",
  },
  {
    numberTrack: 11,
    durationSeconds: 164.136,
    title: "漏拍情話",
    subtitle: "邹沛沛",
    imageUrl: "/images/mkt/cover-028.jpg",
    audioUrl: "/music/漏拍情話.mp3",
    type: "pulled",
  },
  {
    numberTrack: 12,
    durationSeconds: 221.376,
    title: "漫步香港1999",
    subtitle: "白浩贤BlueC",
    imageUrl: "/images/mkt/cover-034.jpg",
    audioUrl: "/music/漫步香港1999.mp3",
    type: "pulled",
  },
  {
    numberTrack: 13,
    durationSeconds: 171.336,
    title: "空白",
    subtitle: "Pank, 羅凱元",
    imageUrl: "/images/mkt/cover-040.jpg",
    pMobileBackground: "right",
    audioUrl: "/music/空白.mp3",
    type: "pulled",
  },
  {
    numberTrack: 14,
    durationSeconds: 206.544,
    title: "红线",
    subtitle: "邹沛沛, Pank",
...
const legacyGalleryItems = withGalleryDefaults(
[
  {
    numberTrack: 0,
  ...
  },
  {
    ...
    title: "Thịt Lợn",
    subtitle: "RPT MCK",
    imageUrl: "/images/mkt/cover-101.jpg",
...
const displayModeStorageKey = "mkt-display-mode";
const displayStyleStorageKey = "mkt-display-style";
const dockPinnedStorageKey = "mkt-dock-pinned";
...
export function MKTScreen() {
  ...
  const isAgeGateOpen = false;
  const hasConfirmedAge = true;
  ...
  const onPointerMove = useCallback((event: React.PointerEvent<HTMLDivElement>) => {
    ...
    if (now - lastDragSoundAt.current >= 60) {
      ...
      window.dispatchEvent(new CustomEvent("mkt-drag-motion", { detail: Math.hypot(deltaX, deltaY) * 10 }));
    }
  ...
  const onWheel = useCallback((event: React.WheelEvent<HTMLDivElement>) => {
    ...
    window.dispatchEvent(
      new CustomEvent("mkt-drag-motion", { detail: Math.hypot(event.deltaX, event.deltaY) }),
    );
  ...
  const handleMobileTrackListScroll = useCallback((event: React.UIEvent<HTMLDivElement>) => {
    ...
    if (!isMobile && Math.abs(scrollDelta) >= 1) {
      ...
      if (now - lastDragSoundAt.current >= 60) {
        lastDragSoundAt.current = now;
        window.dispatchEvent(new CustomEvent("mkt-drag-motion", { detail: Math.abs(scrollDelta) * 10 }));
      }
    }
        ...
        <div className={`scene-utility-controls ${areSceneControlsVisible ? "" : "is-hidden"}`}>
          ...
          >
            <span className="display-mode-toggle__status" aria-hidden="true">
              {displayMode === "full" ? "FULL ALBUM" : "BÀI ĐÃ CÓ"}
            </span>
            <svg aria-hidden="true" viewBox="0 0 24 24" fill="none">
              <path d="M11 12H3" />
              <path d="M16 6H3" />
            ...
            <div className="settings-modal__list">
              ...
              <div className="settings-modal__row">
                ...
                <div className="settings-modal__choices" role="group" aria-label="Chế độ hiển thị">
                  ...
                  >
                    <span>BÀI ĐÃ CÓ ({playableTrackCount})</span>
                  </button>
                  <button
                  ...
                  >
                    <span>FULL ALBUM ({galleryItems.length})</span>
                  </button>
                </div>
              </div>
